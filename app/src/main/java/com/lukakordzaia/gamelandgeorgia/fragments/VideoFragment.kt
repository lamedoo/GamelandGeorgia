...
class VideoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val requestCall = destinationService.getAllVideoList(page)
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    fr_recyclerView_video.apply {
                        ...
                        sv_fragment_video.setOnScrollChangeListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        srl_fragment_video.setOnRefreshListener {
            Toast.makeText(activity, "Refreshed!", Toast.LENGTH_SHORT).show()
            srl_fragment_video.isRefreshing = false
        }
